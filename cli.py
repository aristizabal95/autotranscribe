...
def cli():
    ...
    parser.add_argument(
        "--extract",
        action="store_true",
        help="Extract vocals from the original audio. Default is False.",
        required=False,
        default=False,
    )
    ...
    parser.add_argument(
        "--text",
        action="store_true",
        help="Store the output as a text file instead of a subtitle format. Default is False",
        required=False,
        default=False, 
    )
        ...
        for media_file in input_path.glob("*"):
            ...
            if (
                ...
                transcribe(
                    ...
                    vocal_extracter=extract_vocals,
