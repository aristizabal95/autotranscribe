...
def transcribe(
    ...
    *,
    ...
    if subtitle is None:
        ...
        subtitle_path = Path(clean_subtitle)

    if output_text:
        subtitle_path = subtitle_path.with_suffix(".txt")
    else:
    ...
    if vocal_extracter:
        ...
        cmd = rf'demucs --two-stems=vocals "{media_new_filepath}" -o "{demucs_directory}" --filename "vocals.wav"'
